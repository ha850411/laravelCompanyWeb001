...
<div id="right-panel" class="right-panel">
    ...
    <!-- /header -->
    <!-- Header-->
    @include('admin.include.model1Management_modal')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title">機種管理</strong>
                        <button type="button" class="btn btn-success ml-3 mb-1" data-toggle="modal" data-target="#addCustomer">新增機種</button>
                        <!-- <a href="/memberExcel"><button type="button" class="btn btn-success ml-3 mb-1">匯出</button></a> -->
                    </div>
                    <div class="card-body">

                        <div class="card-body  card-body-template">
                            <table id="model1Management"
